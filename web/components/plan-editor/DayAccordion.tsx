...
interface DayAccordionProps {
  ...
  onExerciseNameChange: (dayIndex: number, exerciseIndex: number, name: string) => void;
  ...
  onLoadKgChange: (dayIndex: number, exerciseIndex: number, value: number) => void;
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="space-y-2">
                ...
                <ExerciseTable
                  ...
                  onExerciseNameChange={(exIdx, name) => onExerciseNameChange(dayIdx, exIdx, name)}
                  onSetsChange={(exIdx, value) => onSetsChange(dayIdx, exIdx, value)}
                  onRepsChange={(exIdx, value) => onRepsChange(dayIdx, exIdx, value)}
                  onLoadKgChange={(exIdx, value) => onLoadKgChange(dayIdx, exIdx, value)}
