            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="space-y-2">
                ...
                <DayAccordion
                  ...
                  onExerciseNameChange={(dayIdx, exIdx, name) =>
                    onExerciseNameChange(weekIdx, dayIdx, exIdx, name)
                  }
                  ...
                  onLoadKgChange={(dayIdx, exIdx, value) =>
                    onLoadKgChange(weekIdx, dayIdx, exIdx, value)
                  }
