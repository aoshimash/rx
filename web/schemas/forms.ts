import { z } from 'zod';
import type { EntryType, ProgramNodeCreate } from '@/types/api';
...
export const programNodeSchema: z.ZodType<ProgramNodeCreate> = z.lazy(() =>
  z.object({
    name: z.string().min(1, 'Name is required').max(200, 'Name too long'),
    node_type: z.string().min(1, 'Type is required').max(50, 'Type too long'),
...
export type ProgramNodeFormData = z.infer<typeof programNodeSchema>;
